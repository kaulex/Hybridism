...
class Stock extends React.Component {
    ...
    constructor(props)
    {
        ...
        //console.log(this.state.unTabColor[this.state.indice])
        ...
        <View style={styles.container}>        
            ...
            <View style={styles.tableStock}>
                <FlatList
                    ...
                    renderItem={({item}) => <UneLigneStockItem uneLigneStock={item} unTabColor={this.state.unTabColor[this.state.indice]} unIndice={this.state.indice}/>}
                />
            </View>
        </View>
        </ImageBackground>
