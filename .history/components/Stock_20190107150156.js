      ...
      <View style={styles.container}>
        ...
        <View style={styles.tableStock}>
            ...
            <FlatList
                ...
                keyExtractor={(item) => item.voyage_ID.toString()}
                renderItem={({item}) => <TouchableOpacity onPress={() => this._detailsVoyage(item.voyage_ID)}><DestinationItem voyages={item}/></TouchableOpacity>}
            />
        </View>
      </View>
    )
