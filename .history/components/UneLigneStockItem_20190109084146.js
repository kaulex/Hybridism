...
class UneLigneStockItem extends React.Component{
        ...
        _verifTotal = (nbrStock) =>
  {
    ...
    {
        this.setState({lignePieces: "<Text style={{flex: 0.5, textAlign: 'right', padding: 10, fontSize: 12, color: 'white'}}>{ uneLigneStock.Tshirt_NbrStock } pièces</Text>"})
    }
  }
    ...
    render (){
        ...
        _verifTotal(uneLigneStock.Tshirt_NbrStock)
