...
class UneLigneStockItem extends React.Component{
    ...
    render (){
        ...
        const couleurStock = this.props.couleurStock

        console.log("ma couleur : " +this.props.couleurStock)
        ...
        return(    
         ...
         <View>
                <View style={styles.tabStockRef}>
                    ...
                    <Text style={{flex: 0.5, textAlign: 'right', padding: 10, fontSize: 12, color: couleurStock}}>{ uneLigneStock.Tshirt_NbrStock } pièces</Text>
                </View>
         </View>
        )
    }
