...
class Stock extends React.Component {
  ...
  render() {
    return ( 
        <ImageBackground source={require('../assets/fond.png')} style={{width: '100%', height: '100%'}}></ImageBackground>
        <View style={styles.container}>        
            <View style={styles.vueBenef}>
                ...
                <Icon name='shopping-basket' type='font-awesome' style={styles.icone}/> 
                    <Text style={{fontSize:18, fontWeight:"bold", textAlign: 'center', }}>   { this.state.panier }</Text>
