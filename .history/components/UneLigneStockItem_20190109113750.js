...
class UneLigneStockItem extends React.Component{
    ...
    render (){
        ...
        console.log(unTabColor[this.state.j])
        ...
        return(    
         ...
         <View>
                <View style={styles.tabStockRef}>
                    ...
                    <Text style={{flex: 0.5, textAlign: 'right', padding: 10, fontSize: 12, color: unTabColor[this.state.j]}}>{ uneLigneStock.Tshirt_NbrStock } pièces</Text>
