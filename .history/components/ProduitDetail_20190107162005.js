...
export default class ProduitDetail extends Component {
  ...
  constructor(props)
    {
        ...
        this.state.unProduit.forEach(element => { 
          ...
          {
            this.setState({message : this.state.tailleTshirt+" – "+this.state.couleurTshirt+" – "+this.state.catTshirt+" ID TSHIRT : "+this.state.idTshirt})
  ...
  _onPressUpdate(){
    recupererLeStock(this.state.idTshirt)
  }
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.main_container}>
        ...
        <TouchableOpacity style={styles.oui_btn} onPress={() => this._onPressUpdate()}><Text>Oui</Text></TouchableOpacity>
