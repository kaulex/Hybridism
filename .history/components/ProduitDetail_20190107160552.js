  ...
  constructor(props)
    {
        ...
        this.state.unProduit.forEach(element => { 
          ...
          if(this.props.navigation.state.params.detail == tailleTshirt+" - "+couleurTshirt+" - "+catTshirt)
          {
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.main_container}>
        <Text style={styles.detail_text}> {this.props.navigation.state.params.detail} - {this.state.tailleTshirt+" - "+this.state.couleurTshirt+" - "+this.state.catTshirt}</Text>
