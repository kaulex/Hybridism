    ...
    constructor(props)
    {
        ...
        this.state.unStock.forEach(element => { 
            ...
            if(this.state.nbrStock < 5)
            {
                ...
                this.state.unTabColor.push(couleur = colorr)

                console.log(this.state.unTabColor.colorr)
        ...
        <View style={styles.container}>        
            ...
            <View style={styles.tableStock}>
                <FlatList
                    ...
                    renderItem={({item}) => <UneLigneStockItem uneLigneStock={item} unTabColor={this.state.unTabColor.colorr}/>}
                />
            </View>
        </View>
        </ImageBackground>
