 ...
 let i = 0
        ...
        this.state.unStock.forEach(element => { 
            ...
            if(this.state.nbrStock < 5)
            {
                ...
                let colorr = 'red'
                this.state.unTabColor.push('cle' = i)
                this.state.unTabColor.push('color' = colorr)
        ...
        <View style={styles.container}>        
            ...
            <View style={styles.tableStock}>
                <FlatList
                    ...
                    data={this.state.unTabColor}
                    keyExtractor={(item) => item.Tshirt_ID.toString()}
                    keyExtractor={(item2) => item2.cle.toString()}
                    renderItem={({item}) => <UneLigneStockItem uneLigneStock={item} unTabColor={item2}/>}
                />
            </View>
        </View>
        </ImageBackground>
