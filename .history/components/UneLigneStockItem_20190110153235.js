...
class UneLigneStockItem extends React.Component{
 ...
 isRed = () => this.state.uneLigneStock.Tshirt_NbrStock < 5 ? "red":"black"
        ...
        return(    
         ...
         <View>
                <View style={styles.tabStockRef}>
                    ...
                    <Text style={{flex: 0.5, textAlign: 'right', padding: 10, fontSize: 12, color: this.state.isRed()}}>{ this.state.uneLigneStock.Tshirt_NbrStock } pièces</Text>
