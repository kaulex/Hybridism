...
class UneLigneStockItem extends React.Component{
    ...
    render (){
        ...
        console.log(uneLigneStock.Tshirt_ID)

        for(let i = 0; i < uneLigneStock.length; i++){
            tabI.push(i)
        }
        ...
        return(    
         ...
         <View>
                <View style={styles.tabStockRef}>
                    ...
                    <Text style={{flex: 0.5, textAlign: 'right', padding: 10, fontSize: 12, color: unTabColor[tabI]}}>{ uneLigneStock.Tshirt_NbrStock } pièces</Text>
