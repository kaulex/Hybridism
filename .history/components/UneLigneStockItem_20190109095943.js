        ...
        return(    
         ...
         <View>
                <View style={styles.tabStockRef}>
                    ...
                    <Text style={{flex: 0.5, textAlign: 'right', padding: 10, fontSize: 12, color: uneLigneStock.Couleur_Libelle}}>{ uneLigneStock.Tshirt_NbrStock } pièces</Text>
