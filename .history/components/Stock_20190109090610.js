...
class Stock extends React.Component {
    ...
    constructor(props)
    {
        ...
        if(this.state.unStock.Tshirt_NbrStock < 5)
        {
            this.setState({couleurStock: '#f00'})
            console.log(this.state.couleur)
        }
        else
        {
            this.setState({couleurStock: '#000'})
            console.log(this.state.couleurStock)
        }
        });
        ...
        <View style={styles.container}>        
            <View style={styles.vueBenef}>
                ...
                <View style={styles.statistiques}>
                    ...
                    <Text style={{fontSiz:18, fontWeight:"bold", color:"#00abff"}}> €</Text>
                </View>
            ...
            <View style={styles.tableStock}>
                <FlatList
                    ...
                    renderItem={({item}) => <UneLigneStockItem uneLigneStock={item} couleurStock={this.state.couleurStock}/>}
                />
            </View>
        </View>
        </ImageBackground>
