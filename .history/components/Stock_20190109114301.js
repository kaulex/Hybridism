    ...
    constructor(props)
    {
        ...
        this.state.unStock.forEach(element => { 
            ...
            if(this.state.nbrStock < 5)
            {
                ...
                let colorr = 'red'
                this.state.unStock[i].push(colorr)
            ...
            else
            {
                ...
                this.state.unStock.push(colorr)
                
               
            }
            
            i++
            this.state.indice.push(i)
        })
        
            
        console.log(this.state.unStock)
        ...
        <View style={styles.container}>        
            ...
            <View style={styles.tableStock}>
                <FlatList
                    ...
                    renderItem={({item}) => <UneLigneStockItem uneLigneStock={item} unTabColor={this.state.unTabColor[this.state.indice]}/>}
                />
            </View>
        </View>
        </ImageBackground>
