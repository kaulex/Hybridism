    ...
    constructor(props)
    {
        ...
        this.state.unStock.forEach(element => { 
            ...
            if(this.state.nbrStock < 5)
            {
                ...
                let newStateArray = this.state.unStock.slice();
                newStateArray.push(this.state.couleur)
                this.setState(unStock: newStateArray)
                console.log(this.state.couleur)
                this.setState({unStock: this.state.unStock.concat(this.state.couleur)})
            }
            else
            {
                this.setState({couleur: 'black'})
                console.log(this.state.couleur)
                this.setState({unStock: unStock.concat(this.state.couleur)})
            }
