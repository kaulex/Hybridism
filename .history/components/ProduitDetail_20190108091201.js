  ...
  constructor(props)
    {
        ...
        this.state.unProduit.forEach(element => { 
          ...
          this.setState({tailleProduit : element.Taille_Libelle })
          this.setState({couleurProduit : element.Couleur_Libelle })
    ...
    return (
      ...
      <View style={styles.main_container}>
        <View style={{flex: 3}}>
          ...
          <View style={{justifyContent: 'center', alignItems: 'center', flex: 1, marginTop: 180}}>
          <Image source={{uri: 'http://prcm.fr/HYBRIDISM/Photos/'+this.state.imageTshirt}}
                    ...
                    <Text>
                      {this.state.tailleProduit}
                    </Text>
                    <Text>
                      {this.state.couleurProduit}
                    </Text>
          </View>
        </View>
        <View style={{flex: 1, position: 'absolute', bottom: 0, right: 1, left: 1, height: 50,}}>
