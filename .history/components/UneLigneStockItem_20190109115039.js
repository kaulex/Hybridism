...
console.log(unTabColor[uneLigneStock.Tshirt_ID])
        ...
        return(    
         ...
         <View>
                <View style={styles.tabStockRef}>
                    ...
                    <Text style={{flex: 0.5, textAlign: 'right', padding: 10, fontSize: 12, color: unTabColor[uneLigneStock.Tshirt_ID]}}>{ uneLigneStock.Tshirt_NbrStock } pièces</Text>
