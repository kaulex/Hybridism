...
export function ajouterUneUnitePanierCD () {
    const url = 'http://prcm.fr/HYBRIDISM/ajouterUneUniteTotalCD.php'

    return fetch(url)
    .then((response) => response.json())
}

export function ajouterAuTotalCD () {
    const url = 'http://prcm.fr/HYBRIDISM/ajouterTotalCD.php'
